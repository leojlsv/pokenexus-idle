...
**Current action:** PM selects/activates the next roadmap task explicitly. TASK-025 is dependency-clear on TASK-089 but remains **PLANNED**; TASK-090 also remains **PLANNED**. TASK-089's former PostgreSQL evidence deferral is closed by a fresh disposable-PG17 `4/4` PASS with no source change.
